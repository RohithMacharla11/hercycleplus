...
import 'blog_screen.dart'; // Import detailed BlogScreen
...
class _BottomNavState extends State<BottomNav> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TopNav(
        onTabSelected: _onItemTapped, // Pass callback to TopNav
      ),
      drawer: const TopNavDrawer(), // Drawer for small screens
      body: IndexedStack(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        unselectedItemColor: AppColors.deepPlum,
        backgroundColor: Colors.white,
